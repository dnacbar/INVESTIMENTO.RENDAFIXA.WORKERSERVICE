...
public sealed class CronJobConsultaEAdicionaRendimentoDiario(ILogger<CronJobConsultaEAdicionaRendimentoDiario> _logger,
    AdicionaORendimentoNaPosicaoDeHoje _aplicaRendimentoNaPosicaoDeHoje) : IJob
{
